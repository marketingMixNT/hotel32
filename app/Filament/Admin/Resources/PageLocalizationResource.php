...
use App\Filament\Admin\Resources\PageLocalizationResource\Pages;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Admin\Resources\PageLocalizationResource\RelationManagers;

class PageLocalizationResource extends Resource
{
    ...
    {
        return ['pl', 'en'];}
    protected static ?string $model = PageLocalization::class;
                        ...
                        ->schema([
                            Forms\Components\TextInput::make('heading')
                                ...
                                ->columnSpanFull(),
                                    ...
                                    // Repeater::make('pageLocalizationBlocks')
                                    //     ->schema(PageLocalizationBlock::getForm())
                                    //     ->label('')
                                    //     ->relationship()
                                    //     ->columnSpanFull()
                                    //     ->reorderable()
    ...
    public static function table(Table $table): Table
    {
        ...
        Tables\Columns\TextColumn::make('header_heading')
            ->label('Nagłowek')
            ->description(function (PageLocalization $record) {
    ...
    {
        return [
            'index' => Pages\ListPageLocalizations::route('/'),
            'create' => Pages\CreatePageLocalization::route('/create'),
            'edit' => Pages\EditPageLocalization::route('/{record}/edit'),
        ];
    }
