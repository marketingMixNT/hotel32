...
use App\Filament\Admin\Resources\PageGalleryResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Admin\Resources\PageGalleryResource\RelationManagers;

class PageGalleryResource extends Resource
{
    use Translatable;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            Tables\Columns\TextColumn::make('header_heading')
                ->label('Nagłowek')
                ->description(function (PageGallery $record) {
    ...
    {
        return [
            'index' => Pages\ListPageGalleries::route('/'),
            'create' => Pages\CreatePageGallery::route('/create'),
