...
use App\Filament\Admin\Resources\PageContactResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Admin\Resources\PageContactResource\RelationManagers;
                ...
                Tabs::make('Tabs')
                    ...
                    ->tabs([
                        ...
                        Tabs\Tab::make('Treść')
                            ...
                            ->columns()
                            ->schema([Forms\Components\TextInput::make('heading')
                                ->label('Nagłowek')
                                ->required()
                                ->columnSpanFull(),]),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('header_heading')
                    ->label('Nagłowek')
                    ->description(function (PageContact $record) {
