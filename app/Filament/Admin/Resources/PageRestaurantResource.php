...
use App\Filament\Admin\Resources\PageRestaurantResource\Pages;
use Livewire\Features\SupportFileUploads\TemporaryUploadedFile;
use Schmeits\FilamentCharacterCounter\Forms\Components\TextInput;
use App\Filament\Admin\Resources\PageRestaurantResource\RelationManagers;



class PageRestaurantResource extends Resource
{
    use Translatable;
    ...
    {
        return ['pl', 'en'];}
    protected static ?string $model = PageRestaurant::class;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            Tables\Columns\TextColumn::make('header_heading')
                ->label('Nagłowek')
                ->description(function (PageRestaurant $record) {
    ...
    {
        return [
            'index' => Pages\ListPageRestaurants::route('/'),
            'create' => Pages\CreatePageRestaurant::route('/create'),
            'edit' => Pages\EditPageRestaurant::route('/{record}/edit'),
        ];
    }
